...
function Trip() {
  return (
    <div className="trip">
      ...
      text="Indonesia, offically the Republic of Indonesia, is a country in Southeast Asia and Oceania between the Indian and Pacific oceans, It consists of over 17,000 islands, including Sumatra, Java, Sulawesi, and part of Borneo and New Guinea."
